...
#define GMAC_MX_FRAME_SIZE_1518  0
#define GMAC_MX_FRAME_SIZE_1536  1
#define GMAC_MX_FRAME_SIZE_JUMBO 2
...
static uint8_t tx_frag_rb_buf_que0_eth_0[MAIN_QUEUE_TX_DESC_COUNT * sizeof(uintptr_t)];
...
#define ETH_MCHP_DATA_DEFN(n)                                                                      \
	static struct gmac_dev_data eth_data_##n = {                                               \
		...
		.phy_connection_type = DT_INST_ENUM_IDX(n, phy_connection_type),                   \
		.queue_list = {{                                                                   \
			.que_idx = GMAC_QUE_0,                                                     \
		.rx_desc_list = {                                                                  \
		...
		.tx_desc_list = {                                                                  \
			...
			.tx_frag_rb = RING_BUF_INIT(tx_frag_rb_buf_que0_eth_##n,		   \
					sizeof(tx_frag_rb_buf_que0_eth_##n)),			   \
		}},                                                                                \
	}
/* clang-format on */
