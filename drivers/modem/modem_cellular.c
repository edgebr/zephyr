...
MODEM_CHAT_SCRIPT_CMDS_DEFINE(quectel_eg915u_init_chat_script_cmds,
			     ...
			     MODEM_CHAT_SCRIPT_CMD_RESP(
				     ...
				     ok_match),
			     MODEM_CHAT_SCRIPT_CMD_RESP(
				     "AT+QJDCFG=\"sinr\"," STRINGIFY(
					     CONFIG_MODEM_CELLULAR_QJD_SINR),
				     ok_match),
			     MODEM_CHAT_SCRIPT_CMD_RESP(
				     ...
				     ok_match),
			     MODEM_CHAT_SCRIPT_CMD_RESP(
				     "AT+QJDCFG=\"rsrp\"," STRINGIFY(
					     CONFIG_MODEM_CELLULAR_QJD_RSRP),
				     ok_match),
			     MODEM_CHAT_SCRIPT_CMD_RESP(
				     "AT+QJDCFG=\"rsrq\"," STRINGIFY(
					     CONFIG_MODEM_CELLULAR_QJD_RSRQ),
				     ok_match),
			     MODEM_CHAT_SCRIPT_CMD_RESP(
				     "AT+QJDCFG=\"rssi\"," STRINGIFY(
					     CONFIG_MODEM_CELLULAR_QJD_RSSI),
				     ok_match),
			     MODEM_CHAT_SCRIPT_CMD_RESP(
...
#define MODEM_CELLULAR_DEVICE_QUECTEL_EG915U(inst)                                                 \
	...
	MODEM_CELLULAR_DEFINE_AND_INIT_USER_PIPES(inst, (user_pipe_0, 3), (user_pipe_1, 4))        \
                                                                                                   \
	MODEM_CELLULAR_DEFINE_INSTANCE(                                                            \
		inst, 3100, 500, 15000, 30000, false, NULL, &quectel_eg915u_init_chat_script,      \
